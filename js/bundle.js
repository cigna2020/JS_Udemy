...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/menu') // Заком. при использовании библ. axios
  .then(function (data) {
...
function forms(formSelector, openModalId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var statusMessage = document.createElement('img'); // 'div' change on 'img'
      ...
      var formData = new FormData(form); //соберает все данные с формы
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModal"])('.modal', openModalId);
    var thanksModal = document.createElement('div');
    thanksModal.classList.add('modal__dialog');
    thanksModal.innerHTML = "\n        <div class=\"modal__content\">\n        <div class=\"modal__close\" data-close>&times;</div>\n        <div class=\"modal__title\">".concat(message, "</div>\n        </div>\n        ");
    document.querySelector('.modal').append(thanksModal); // modal.append(thanksModal);
...
function modal(triggerSelector, modalSelector, openModalId) {
  // ============= Modal Window ========================
  var modalTriger = document.querySelectorAll(triggerSelector),
      modal = document.querySelector(modalSelector);
  modalTriger.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modalSelector, openModalId);
    });
  });
...
function slider(_ref) {
  var container = _ref.container,
      ...
      currentCouner = _ref.currentCouner,
      wrapper = _ref.wrapper,
      field = _ref.field;
  // ========================= Slider =======================
  var slideIndex = 1;
  var offset = 0; // переменная, которая будет отвечать за отступы при смене слайда

  var slides = document.querySelectorAll(slide),
      prev = document.querySelector(prevArrow),
      next = document.querySelector(nextArrow),
      total = document.querySelector(totalCounter),
      // число на странице, которое отображает общее количество слайдов
  ...
  var indicators = document.createElement('ol'),
      // создаем ордер лист для точек (навигация)
  dots = []; // будет массив точек

  indicators.classList.add('carousel-indicators'); // чтобы не изменять файл style.css можно добавить стили с помощью js
  ...
  next.addEventListener('click', function () {
    ...
    if (offset == deleteNotDigits(width) * (slides.length - 1)) {
      // тоже самое, что и выше, но через новсозданую функцию
      offset = 0;
    } else {
      // таким образом с напр. 500рх получаем число 500
  ...
  dots.forEach(function (item) {
    item.addEventListener('click', function (e) {
      var slideTo = e.target.getAttribute('data-slide-to'); //получаем число
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  tabsParent.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains(tabsSelector.slice(1))) {
      //удаляем первый символ - точку класса, потому-что используем classList
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // обязательно вызвать
  var openModalId = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["openModal"])('.modal', openModalId);
  }, 50000);
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', openModalId);
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-10-11');
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])('form', openModalId);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(url, {
              // await - означает что (прим. return-у) нужно дождатся выполнения этой операции (по стандарту срок ожидание до 30 сек.)
              method: "POST",
              headers: {
                'Content-type': 'application/json'
              },
